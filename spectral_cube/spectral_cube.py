...
from astropy.io.fits import PrimaryHDU, Header, Card
...
from .masks import (LazyComparisonMask, BooleanArrayMask,
...
class SpectralCube(BaseNDClass, SpectralAxisMixinClass):
    ...
    from .external_packages import to_yt, to_glue, to_pvextractor, to_ds9
